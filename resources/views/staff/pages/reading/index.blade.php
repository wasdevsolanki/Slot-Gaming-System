...
@endpush
<div class="row admin-right">

    <div class="col-md-12 mb-2">
        <div class="card">
            <div class="card-header bg-primary">Reading</div>
...
<div class="modal fade" id="inModel" tabindex="-1" aria-labelledby="inModelLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form action="{{ route('staff.reading.in') }}" method="POST" id="formIn">
            @csrf
...
<div class="modal fade" id="outModel" tabindex="-1" aria-labelledby="outModelLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form action="{{ route('staff.reading.out') }}" method="POST" id="formOut">
            @csrf
