                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group rounded-pill w-100" role="group" aria-label="Basic example">
                                        ...
                                        <a href="{{ route('staff.payroll.status', encrypt($staff->payroll->first()->id)) }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status == 'success') {
                        window.location.href = '/staff/payroll/staff_list';
                    }
                },
            ...
            success: function(response) {
                ...
                $.each(response.payroll, function(key, value) {
                    ...
                    if( value.checkin && value.checkout) {
                        ...
                        var Status = '';
                        if( value.status == 0 ) {
                            Status = '<span class="badge text-bg-danger rounded-pill p-1 w-75">UPAID</span>';
                        } else {
                            Status = '<span class="badge text-bg-success rounded-pill p-1 w-75">PAID</span>';
                        }
                        ...
                        var list = `
                            <tr>
                                <td style="">
                                    <span>${formattedCheckinDate}</span></br>
