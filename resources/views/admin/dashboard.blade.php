...
<div class="row admin-section h-100">
                            ...
                            @foreach ( $player->points as $point )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.point.checkout') }}" method="post" id="checkoutFormDirect">
                                            @csrf
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('admin.ticket.store')}}" method="post" id="ticketForm">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 rePointInput d-none">
                                                            <div class="form-floating mb-3">
                                                                <input type="number" class="form-control rounded-0" name="repoint" id="AddPointReInput">
    ...
    <div class="col-md-4 admin-right h-100 flex-column justify-content-start">

        <div class="card mb-3">
            <div class="card-header bg-primary">Add up point</div>
            <div class="card-body">

                <form action="{{ route('admin.point.store.form') }}" method="post">
                    @csrf
                    <div class="row">
        ...
        <div class="card w-100 h-100">
            ...
            <div class="card-body isDisplay d-none">
                <div class="row userDetail">
                    ...
                    <div class="col-md-4 d-flex align-items-center mb-3">
                        <img class="rounded-0 w-100 userProfile" src="https://rb.gy/hky7xt" alt="">
                    </div>
                    ...
                    <div class="col-md-12 p-3">
                        <form action="{{ route('admin.point.checkin') }}" method="post" id="checkinForm">
                            @csrf
                            <input type="hidden" name="player_id" class="playerId" value="">
                            <input type="hidden" name="checkin" class="checkinDate" value="">
    
                            <div class="col-md-12 mb-3">
                                <label class="form-label fw-semibold" for="inputMachine">Select machine for player</label>
                                <select class="playerSelect2 form-select" name="machine" id="inputMachine" style="width: 100%" required>
            ...
            <div class="card-body noDisplay p-5 d-flex justify-content-center align-items-center text-secondary display-6">
                No Display
            </div>
        </div>
    </div>
    ...
    function fetchUserDetails(userId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.userBonus').text(response.player.bonus);
                $('.userProfile').attr('src', '/upload/' + response.player.room_id + '/profile/' + response.player.profile);
