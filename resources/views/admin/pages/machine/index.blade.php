                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group rounded-pill w-100" role="group" aria-label="Basic example">
                                    ...
                                    @if( $item->status == 1 )
                                    <a href="{{ route('admin.machine.block', encrypt($item->id)) }}" class="btn btn-sm text-danger-emphasis bg-danger-subtle">BLOCK</a>
                                    @else
                                    <a href="{{ route('admin.machine.active', encrypt($item->id)) }}" class="btn btn-sm text-success-emphasis bg-success-subtle">ACTIVE</a>
                                    @endif
                                </div>
                            </td>
                        </tr>
        ...
        <div class="card w-100">
            ...
            <div class="card-body isDisplay d-none">
                ...
                <div class="p-2 mt-3">
                    ...
                    <form action="{{ route('admin.machine.edit') }}" method="post">
                        @csrf
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('admin.machine.store') }}" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control serialInput" name="serial" id="serialInput" placeholder="Machine Serial" required>
